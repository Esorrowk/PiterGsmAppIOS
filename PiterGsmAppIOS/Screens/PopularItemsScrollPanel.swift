...
struct PopularItemsScrollPanel: View{
    ...
    let popularItems: [PopularItemsScroll] = [
        ...
        PopularItemsScroll(imageName: "HuaweiWatch", itemName: "Смарт-часы Huawei Watch GT 6 41 мм, коричневый(55020FVX)", price: 14_490),
        PopularItemsScroll(imageName: "Iphon17esim", itemName: "Смартфон Apple Iphone 17 eSim 256GB,Lavender(Фиолетовый)", price: 73_990),
